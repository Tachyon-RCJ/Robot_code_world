...
thresholds_g = (40, 84, -36, -12, -19, 10)#コート色
thresholds_b = (56, 67, -24, 3, -52, -36)#青ゴール
...
while(True):
    ...
    if not img == None:
        ...
        if blobs:
            for b in blobs:
                if b.area() > areaA and not(tateline-90 < b.cx() < tateline+90 and yokoline-50 < b.cy() < yokoline+80) and math.sqrt((b.cx()-tateline)**2+(b.cy()-yokoline)**2) < 140:#yokoline:190半径:170
                    areaA = b.area()
                    cxA=b.cx()
                    cyA=b.cy()
                    rectA=b.rect()
        ...
        preRads = rads
        img.draw_rectangle(tateline-90,yokoline-30,180,150,(0,255,255))
